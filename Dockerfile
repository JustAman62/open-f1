...
ARG TARGETARCH
RUN dotnet publish "UndercutF1.Console.csproj" -o /app/publish -a "$TARGETARCH" /p:UseAppHost=false /p:PublicRelease=true /p:PublishAot=false /p:SelfContained=false /p:PublishSingleFile=false
